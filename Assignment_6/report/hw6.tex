		...
		\answer{
			\begin{figure}[H] 
				\begin{center}
					...
					\end{tikzpicture}
				\end{center}
				\caption{Bayes net for the gender and limb angles of MQLs}
		\end{figure}
		\paragraph{Legend:}
		\begin{align*}
			G &= \text{Gender} \\
			...
			%\widehat {XYZ} &= \text{Observed} X Y Z \text{angle} \quad X \in \{\text{Right, Left}\}, Y \in \{\text{inner, outer}\}, Z \in \{\text{arm, leg}\}
		\end{align*}
		}		  
%	\end{subquestion}
\end{question}
